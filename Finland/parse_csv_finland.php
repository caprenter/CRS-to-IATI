...
?>
<?php
 /* Spreadsheet columns for Finland
  * 
  * Year
  * donorcode
  * donorname
...
$default_hierarchy =	"1";
$last_updated	= "2011-08-17T00:00:00";
$reporting_org_ref = "FI-3";
$reporting_org_type ="10";
$reporting_org_name = "Ministry of Foreign Affairs, Finland";
$funding_org_ref = "FI";
$funding_org_type	= "10";
$funding_org_name = "Finland";
...
foreach ($region_codes_array as $region_file) {
    ...
    foreach ($crs_data as $row) {
      if ( $row['recipientcode'] == $region_file) { //check to see if this record is in our country/region of interest
          ...
          //We need to know if this is a new activity or a repeated row of the same activity
          //if its NOT the first row we only need the transaction data.
          ...
          //Transactions are run on every row
